const NEW_CLASSIFIER_INTENT = 'NEW_CLASSIFIER_INTENT';
const EDIT_CLASSIFIER_INTENT = 'EDIT_CLASSIFIER_INTENT';
...
export const editClassifierIntent = classifier => ({
    type: EDIT_CLASSIFIER_INTENT,
    payload: classifier
});

export const newClassifierIntent = () => ({
    type: NEW_CLASSIFIER_INTENT
});

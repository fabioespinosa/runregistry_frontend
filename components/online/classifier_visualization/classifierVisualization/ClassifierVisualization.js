    ...
    return (
      <div>
          ...
          <ul>
            {class_classifiers.map(current_class => (
              <li key={current_class.class}>
                <a onClick={() => this.testClassifier(current_class)}>
                  {current_class.class}
                </a>
              </li>
            ))}
        ...
        <div>
          {run_info ? (
            <div>
              Run information (lumisection attributes reduced to truthy to
              calculate significance and run class) <br />
              <Button onClick={this.getRunInformation}>Refresh</Button>

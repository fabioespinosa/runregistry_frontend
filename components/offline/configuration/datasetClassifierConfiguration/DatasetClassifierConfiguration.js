  ...
  render() {
    ...
    return (
      <div>
        &nbsp;
        <p>
          Whenever a dataset appears in DQM GUI, it will run all the dataset's
          workspace classifiers' to check if the run is significant to the
          respective workspace:
        </p>
        <p>
          If the run is significant to the respective workspace it will appear
        ...
        <Editor
          ...
          editClassifier={async valid_js_object => {
            ...
            await Swal(`Dataset classifier edited successfully`, '', 'success');
          }}
        />
      </div>
    );

...
class DuplicateDatasets extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h3>This tool will allow the DC Expert to duplicate datasets</h3>
            ...
            return (
              <form onSubmit={handleSubmit} className="dataset_copy_form">
                <div className="form_container">
                  Tip:Selecting 'online' will duplicate the original dataset as
                  it came from P5, without any LS alteration afterwards.
                  <br />
                  <br />
                  Source dataset name:
                  <Select
                  ...
                  <Input
                    ...
                    onChange={(evt) =>
                      setFieldValue('target_dataset_name', evt.target.value)
                    }
                    type="text"
                  />
                  <br />

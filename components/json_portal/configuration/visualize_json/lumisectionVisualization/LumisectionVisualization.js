  ...
  render() {
    ...
    return (
      <div>
        ...
        The run {run_number} that this dataset belongs to contains {ls_duration}{' '}
        lumisections:
        <br />
        Lumisections deemed GOOD are:{' '}
        <strong>{JSON.stringify(good_lumisections)}</strong>
        <br />
        You can enter a LS number here to see why that specific LS was
        excluded/included:
        <br />
        <InputNumber
          onChange={(value) => this.inspectLumisection({ name: value })}
        />
        <br />
        Or click on any lumisection:
        <div>
